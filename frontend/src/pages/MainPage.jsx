...
const navItems = [
  ...
  { icon: FileText,        label: 'NFC-e',           active: false },
  { icon: Package,         label: 'Produtos',        active: false },
  { icon: Users,           label: 'Consumidores',    active: false },
  { icon: Building2,       label: 'Estabelecimentos',active: false },
          ...
          >
            <item.icon
              ...
              className={`flex-shrink-0 ${
                item.active
                  ? 'text-vulpes-orange'
                  : 'group-hover:text-vulpes-orange transition-colors'
              }`}
            />
...
const statusStyle = {
  ...
  Gerada:     'bg-blue-100 text-blue-600',
};
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-100 px-6 py-3.5 flex items-center gap-4 shadow-sm">
          ...
          <div className="flex-1 max-w-md relative">
            ...
            <input
              type="text"
              placeholder="Buscar NFC-e, produtos, consumidores…"
              className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-600 placeholder-slate-400 focus:outline-none focus:border-vulpes-orange focus:ring-2 focus:ring-vulpes-orange/20 transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <div className="flex items-center gap-2.5 pl-3 border-l border-slate-100">
              ...
              <div className="hidden sm:block">
                <p className="text-slate-700 text-xs font-semibold">Usuário</p>
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
            ...
            <StatCard
              ...
              positive
              icon={Package}
              gradient="bg-gradient-to-br from-vulpes-orange to-orange-400"
            />
            <StatCard
              title="Rejeições SEFAZ"
              value="3"
              change="-1"
              positive
              icon={TrendingDown}
          ...
          {/* NFC-e recentes + ações rápidas */}
          <div className="grid lg:grid-cols-3 gap-6">
            {/* Tabela recentes */}
            <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
                <h2 className="font-bold text-slate-800 text-sm">NFC-e recentes</h2>
                <button className="flex items-center gap-1 text-vulpes-orange text-xs font-medium hover:text-vulpes-orange-hover transition-colors">
              ...
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <div>
                      <p className="text-slate-700 text-xs font-semibold group-hover:text-vulpes-dark transition-colors">
                        {action.label}
                      </p>
